...
public class WebLinkDefinition  extends rallyws.api.AttributeDefinition  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_09/domain", "WebLinkDefinition"));
