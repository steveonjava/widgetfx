...
public class QueryResult  extends rallyws.api.OperationResult  implements java.io.Serializable {
    ...
    private rallyws.api.DomainObject[] results;
    ...
    public QueryResult(
           ...
           rallyws.api.DomainObject[] results) {
        super(
            ref,
            objectVersion,
            type,
     ...
     * @return results
     */
    public rallyws.api.DomainObject[] getResults() {
        return results;
    }
     ...
     * @param results
     */
    public void setResults(rallyws.api.DomainObject[] results) {
        this.results = results;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_09/domain", "QueryResult"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_09/domain", "DomainObject"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
