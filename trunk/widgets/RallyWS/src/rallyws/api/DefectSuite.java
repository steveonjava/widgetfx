...
public class DefectSuite  extends rallyws.api.Artifact  implements java.io.Serializable {
    ...
    private rallyws.api.Defect[] defects;
     ...
     * @return defects
     */
    public rallyws.api.Defect[] getDefects() {
        return defects;
    }
     ...
     * @param defects
     */
    public void setDefects(rallyws.api.Defect[] defects) {
        this.defects = defects;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_09/domain", "DefectSuite"));
