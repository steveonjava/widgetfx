...
public class UserPermission  extends rallyws.api.DomainObject  implements java.io.Serializable {
     ...
     * @return user
     */
    public rallyws.api.User getUser() {
        return user;
    }
     ...
     * @param user
     */
    public void setUser(rallyws.api.User user) {
        this.user = user;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_09/domain", "UserPermission"));
