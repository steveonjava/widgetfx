...
public class UserProfile  extends rallyws.api.DomainObject  implements java.io.Serializable {
    private java.lang.String dateFormat;

    private java.lang.String dateTimeFormat;

    private rallyws.api.Project defaultProject;

    private rallyws.api.Workspace defaultWorkspace;
    ...
    public UserProfile(
           ...
           rallyws.api.Project defaultProject,
           rallyws.api.Workspace defaultWorkspace,
     ...
     */
    public rallyws.api.Project getDefaultProject() {
        return defaultProject;
    }
     ...
     */
    public void setDefaultProject(rallyws.api.Project defaultProject) {
        this.defaultProject = defaultProject;
    }
     ...
     */
    public rallyws.api.Workspace getDefaultWorkspace() {
        return defaultWorkspace;
    }
     ...
     */
    public void setDefaultWorkspace(rallyws.api.Workspace defaultWorkspace) {
        this.defaultWorkspace = defaultWorkspace;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_09/domain", "UserProfile"));
