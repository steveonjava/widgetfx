...
public class RevisionHistory  extends rallyws.api.WorkspaceDomainObject  implements java.io.Serializable {
    private rallyws.api.Revision[] revisions;
    ...
    public RevisionHistory(
           ...
           rallyws.api.Revision[] revisions) {
        super(
            ref,
            objectVersion,
            type,
     ...
     * @return revisions
     */
    public rallyws.api.Revision[] getRevisions() {
        return revisions;
    }
     ...
     * @param revisions
     */
    public void setRevisions(rallyws.api.Revision[] revisions) {
        this.revisions = revisions;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_09/domain", "RevisionHistory"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("revisions");
        elemField.setXmlName(new javax.xml.namespace.QName("", "Revisions"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_09/domain", "Revision"));
