...
public class Project  extends rallyws.api.WorkspaceDomainObject  implements java.io.Serializable {
    private rallyws.api.BuildDefinition[] buildDefinitions;

    private rallyws.api.Project[] children;

    private java.lang.String description;

    private rallyws.api.Iteration[] iterations;
    ...
    private rallyws.api.Project parent;

    private rallyws.api.Release[] releases;

    private java.lang.String state;

    private rallyws.api.User[] users;
    ...
    public Project(
           ...
           rallyws.api.BuildDefinition[] buildDefinitions,
           rallyws.api.Project[] children,
           java.lang.String description,
           rallyws.api.Iteration[] iterations,
           java.lang.String name,
           java.lang.String notes,
           java.lang.String owner,
           rallyws.api.Project parent,
           rallyws.api.Release[] releases,
           java.lang.String state,
           rallyws.api.User[] users) {
        super(
            ref,
            objectVersion,
            type,
     ...
     */
    public rallyws.api.BuildDefinition[] getBuildDefinitions() {
        return buildDefinitions;
    }
     ...
     */
    public void setBuildDefinitions(rallyws.api.BuildDefinition[] buildDefinitions) {
        this.buildDefinitions = buildDefinitions;
    }
     ...
     * @return children
     */
    public rallyws.api.Project[] getChildren() {
        return children;
    }
     ...
     * @param children
     */
    public void setChildren(rallyws.api.Project[] children) {
        this.children = children;
    }
     ...
     * @return iterations
     */
    public rallyws.api.Iteration[] getIterations() {
        return iterations;
    }
     ...
     * @param iterations
     */
    public void setIterations(rallyws.api.Iteration[] iterations) {
        this.iterations = iterations;
    }
     ...
     * @return parent
     */
    public rallyws.api.Project getParent() {
        return parent;
    }
     ...
     * @param parent
     */
    public void setParent(rallyws.api.Project parent) {
        this.parent = parent;
    }
     ...
     * @return releases
     */
    public rallyws.api.Release[] getReleases() {
        return releases;
    }
     ...
     * @param releases
     */
    public void setReleases(rallyws.api.Release[] releases) {
        this.releases = releases;
    }
     ...
     * @return users
     */
    public rallyws.api.User[] getUsers() {
        return users;
    }
     ...
     * @param users
     */
    public void setUsers(rallyws.api.User[] users) {
        this.users = users;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_09/domain", "Project"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_09/domain", "BuildDefinition"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_09/domain", "User"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
