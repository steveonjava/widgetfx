...
public class ConversationPost  extends rallyws.api.WorkspaceDomainObject  implements java.io.Serializable {
    private rallyws.api.Artifact artifact;
     ...
     * @return artifact
     */
    public rallyws.api.Artifact getArtifact() {
        return artifact;
    }
     ...
     * @param artifact
     */
    public void setArtifact(rallyws.api.Artifact artifact) {
        this.artifact = artifact;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_09/domain", "ConversationPost"));
