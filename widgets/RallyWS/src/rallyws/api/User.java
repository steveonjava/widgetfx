...
public class User  extends rallyws.api.DomainObject  implements java.io.Serializable {
    ...
    private rallyws.api.UserPermission[] userPermissions;

    private rallyws.api.UserProfile userProfile;
    ...
    public User(
           ...
           rallyws.api.UserPermission[] userPermissions,
           rallyws.api.UserProfile userProfile) {
        super(
            ref,
            objectVersion,
            type,
     ...
     */
    public rallyws.api.UserPermission[] getUserPermissions() {
        return userPermissions;
    }
     ...
     */
    public void setUserPermissions(rallyws.api.UserPermission[] userPermissions) {
        this.userPermissions = userPermissions;
    }
     ...
     * @return userProfile
     */
    public rallyws.api.UserProfile getUserProfile() {
        return userProfile;
    }
     ...
     * @param userProfile
     */
    public void setUserProfile(rallyws.api.UserProfile userProfile) {
        this.userProfile = userProfile;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_09/domain", "User"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_09/domain", "UserPermission"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_09/domain", "UserProfile"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
