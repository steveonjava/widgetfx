...
public class Iteration  extends rallyws.api.WorkspaceDomainObject  implements java.io.Serializable {
    ...
    private rallyws.api.UserIterationCapacity[] userIterationCapacities;
    ...
    public Iteration(
           ...
           rallyws.api.UserIterationCapacity[] userIterationCapacities) {
        super(
            ref,
            objectVersion,
            type,
     ...
     */
    public rallyws.api.UserIterationCapacity[] getUserIterationCapacities() {
        return userIterationCapacities;
    }
     ...
     */
    public void setUserIterationCapacities(rallyws.api.UserIterationCapacity[] userIterationCapacities) {
        this.userIterationCapacities = userIterationCapacities;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_09/domain", "Iteration"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_09/domain", "UserIterationCapacity"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
