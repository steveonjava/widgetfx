...
public class Build  extends rallyws.api.WorkspaceDomainObject  implements java.io.Serializable {
    private rallyws.api.BuildDefinition buildDefinition;
    ...
    public Build(
           ...
           rallyws.api.BuildDefinition buildDefinition,
     ...
     */
    public rallyws.api.BuildDefinition getBuildDefinition() {
        return buildDefinition;
    }
     ...
     */
    public void setBuildDefinition(rallyws.api.BuildDefinition buildDefinition) {
        this.buildDefinition = buildDefinition;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_09/domain", "Build"));
