...
public class TestCase  extends rallyws.api.Artifact  implements java.io.Serializable {
    ...
    private rallyws.api.TestCaseResult[] results;

    private java.lang.String risk;

    private rallyws.api.TestCaseStep[] steps;

    private rallyws.api.TestFolder testFolder;
    ...
    private rallyws.api.Artifact workProduct;
    ...
    public TestCase(
           ...
           rallyws.api.TestCaseResult[] results,
           java.lang.String risk,
           rallyws.api.TestCaseStep[] steps,
           rallyws.api.TestFolder testFolder,
           java.lang.String type,
           java.lang.String validationExpectedResult,
           java.lang.String validationInput,
           rallyws.api.Artifact workProduct) {
        super(
            ref,
            objectVersion,
            _type,
     ...
     * @return results
     */
    public rallyws.api.TestCaseResult[] getResults() {
        return results;
    }
     ...
     * @param results
     */
    public void setResults(rallyws.api.TestCaseResult[] results) {
        this.results = results;
    }
     ...
     * @return steps
     */
    public rallyws.api.TestCaseStep[] getSteps() {
        return steps;
    }
     ...
     * @param steps
     */
    public void setSteps(rallyws.api.TestCaseStep[] steps) {
        this.steps = steps;
    }
     ...
     * @return testFolder
     */
    public rallyws.api.TestFolder getTestFolder() {
        return testFolder;
    }
     ...
     * @param testFolder
     */
    public void setTestFolder(rallyws.api.TestFolder testFolder) {
        this.testFolder = testFolder;
    }
     ...
     * @return workProduct
     */
    public rallyws.api.Artifact getWorkProduct() {
        return workProduct;
    }
     ...
     * @param workProduct
     */
    public void setWorkProduct(rallyws.api.Artifact workProduct) {
        this.workProduct = workProduct;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_09/domain", "TestCase"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_09/domain", "TestCaseStep"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_09/domain", "Artifact"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
