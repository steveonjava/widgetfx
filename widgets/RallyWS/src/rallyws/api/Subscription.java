...
public class Subscription  extends rallyws.api.PersistableObject  implements java.io.Serializable {
    ...
    private rallyws.api.Workspace[] workspaces;
    ...
    public Subscription(
           ...
           rallyws.api.Workspace[] workspaces) {
        super(
            ref,
            objectVersion,
            type,
     ...
     * @return workspaces
     */
    public rallyws.api.Workspace[] getWorkspaces() {
        return workspaces;
    }
     ...
     * @param workspaces
     */
    public void setWorkspaces(rallyws.api.Workspace[] workspaces) {
        this.workspaces = workspaces;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_09/domain", "Subscription"));
