...
public class AttributeDefinition  extends rallyws.api.WorkspaceDomainObject  implements java.io.Serializable {
    private rallyws.api.AllowedQueryOperator[] allowedQueryOperators;

    private rallyws.api.TypeDefinition allowedValueType;

    private rallyws.api.AllowedAttributeValue[] allowedValues;
    ...
    public AttributeDefinition(
           ...
           rallyws.api.AllowedQueryOperator[] allowedQueryOperators,
           rallyws.api.TypeDefinition allowedValueType,
           rallyws.api.AllowedAttributeValue[] allowedValues,
     ...
     */
    public rallyws.api.AllowedQueryOperator[] getAllowedQueryOperators() {
        return allowedQueryOperators;
    }
     ...
     */
    public void setAllowedQueryOperators(rallyws.api.AllowedQueryOperator[] allowedQueryOperators) {
        this.allowedQueryOperators = allowedQueryOperators;
    }
     ...
     */
    public rallyws.api.TypeDefinition getAllowedValueType() {
        return allowedValueType;
    }
     ...
     */
    public void setAllowedValueType(rallyws.api.TypeDefinition allowedValueType) {
        this.allowedValueType = allowedValueType;
    }
     ...
     */
    public rallyws.api.AllowedAttributeValue[] getAllowedValues() {
        return allowedValues;
    }
     ...
     * @param allowedValues
     */
    public void setAllowedValues(rallyws.api.AllowedAttributeValue[] allowedValues) {
        this.allowedValues = allowedValues;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_09/domain", "AttributeDefinition"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_09/domain", "AllowedQueryOperator"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_09/domain", "AllowedAttributeValue"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
