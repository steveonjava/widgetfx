...
public class IterationCumulativeFlowData  extends rallyws.api.CumulativeFlowData  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_09/domain", "IterationCumulativeFlowData"));
